swig -debug-memory -debug-classes -debug-symtabs -debug-tmsearch -debug-tmused -debug-symbols -debug-csymbols -debug-lsymbols -debug-typemap -debug-template -csharp -c++ -I./swigged.llvm.native -I../llvm/llvm/include -namespace Swigged.LLVM -dllimport swigged-llvm-native -outdir ./std.swigged.llvm -o ./swigged.llvm.native/LLVM_wrap.cpp LLVM.i
