...
namespace UnitTestProject6
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMultiModules()
        {
            ...
            uint xx = LLVM.OrcAddLazilyCompiledIR(ojsr, mod1, null, ctx);
            xx = LLVM.OrcAddLazilyCompiledIR(ojsr, mod2, null, ctx);
            xx = LLVM.OrcAddLazilyCompiledIR(ojsr, mod3, null, ctx);
            ulong p = LLVM.OrcGetSymbolAddress(ojsr, "comb");
            Comb combMethod = (Comb)Marshal.GetDelegateForFunctionPointer((System.IntPtr)p, typeof(Comb));
