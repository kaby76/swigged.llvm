...
public class LLVM {
  ...
  public unsafe static SWIGTYPE_p_f_LLVMDiagnosticInfoRef_p_void__void ContextGetDiagnosticHandler(ContextRef C) {
    global::System.IntPtr cPtr = LLVMPINVOKE.ContextGetDiagnosticHandler(C.Value);
    SWIGTYPE_p_f_LLVMDiagnosticInfoRef_p_void__void ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_f_LLVMDiagnosticInfoRef_p_void__void(cPtr, false);
    return ret;
  }
  ...
  public unsafe static string GetStringAttributeKind(AttributeRef A, SWIGTYPE_p_unsigned_int Length) {
    string ret = LLVMPINVOKE.GetStringAttributeKind(A.Value, SWIGTYPE_p_unsigned_int.getCPtr(Length));
    return ret;
  }

  public unsafe static string GetStringAttributeValue(AttributeRef A, SWIGTYPE_p_unsigned_int Length) {
    string ret = LLVMPINVOKE.GetStringAttributeValue(A.Value, SWIGTYPE_p_unsigned_int.getCPtr(Length));
    return ret;
  }
  ...
  public unsafe static string GetMDString(ValueRef V, SWIGTYPE_p_unsigned_int Length) {
    string ret = LLVMPINVOKE.GetMDString(V.Value, SWIGTYPE_p_unsigned_int.getCPtr(Length));
    return ret;
  }
  ...
  public unsafe static SWIGTYPE_p_unsigned_int GetIndices(ValueRef Inst) {
    global::System.IntPtr cPtr = LLVMPINVOKE.GetIndices(Inst.Value);
  ...
  public unsafe static MCJITMemoryManagerRef CreateSimpleMCJITMemoryManager(System.IntPtr Opaque, SWIGTYPE_p_f_p_void_unsigned_int_unsigned_int_unsigned_int_p_q_const__char__p_unsigned_char AllocateCodeSection, SWIGTYPE_p_f_p_void_unsigned_int_unsigned_int_unsigned_int_p_q_const__char_bool__p_unsigned_char AllocateDataSection, SWIGTYPE_p_f_p_void_p_p_char__bool FinalizeMemory, SWIGTYPE_p_f_p_void__void Destroy) {
		MCJITMemoryManagerRef ret = new MCJITMemoryManagerRef(LLVMPINVOKE.CreateSimpleMCJITMemoryManager(Opaque, SWIGTYPE_p_f_p_void_unsigned_int_unsigned_int_unsigned_int_p_q_const__char__p_unsigned_char.getCPtr(AllocateCodeSection), SWIGTYPE_p_f_p_void_unsigned_int_unsigned_int_unsigned_int_p_q_const__char_bool__p_unsigned_char.getCPtr(AllocateDataSection), SWIGTYPE_p_f_p_void_p_p_char__bool.getCPtr(FinalizeMemory), SWIGTYPE_p_f_p_void__void.getCPtr(Destroy)));
		return ret;
	}
