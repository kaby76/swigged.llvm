...
# curl -O x64-Debug.tar.gz https://github.com/kaby76/llvm/Releases/download/v6.0.4/x64-Debug.tar.gz
# echo "Unpacking binaries..."
# bash -lc "pwd"
# bash -lc "gzip -d x64-Debug.tar.gz"
# bash -lc "tar -xvf x64-Debug.tar"
# rm x64-Debug.tar -Force -erroraction 'silentlycontinue'
